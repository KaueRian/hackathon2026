...
export default function CorrigidoClient() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900 cursor-default">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {submitted ? (
          <div className="max-w-md mx-auto bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100 text-center mx-4 sm:mx-auto">
