...
export function CookiePopup() {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full h-[80vh] bg-[var(--primary)] bg-opacity-95 z-[9999] p-8 flex flex-col justify-center items-center shadow-[0_-10px_50px_rgba(0,0,0,0.5)] border-t-8 border-red-500">
      <h1 className="text-6xl font-black mb-8 text-black text-center uppercase tracking-tighter">
      ...
      <div className="flex gap-8 items-center w-full justify-center">
        ...
        <RunawayButton 
          className="bg-black text-[#00ff08] text-4xl px-12 py-6 border-4 border-[#00ff08] shadow-[0_0_20px_#00ff08]"
